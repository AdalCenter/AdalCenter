    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_email_ru', models.EmailField(max_length=254, null=True, verbose_name='Электронная почта компании')),
                ('company_email_en', models.EmailField(max_length=254, null=True, verbose_name='Электронная почта компании')),
                ('company_email_ky', models.EmailField(max_length=254, null=True, verbose_name='Электронная почта компании')),
                ...
                ('trademark_ru', models.CharField(max_length=255, null=True, unique=True, verbose_name='Товарный знак')),
                ('trademark_en', models.CharField(max_length=255, null=True, unique=True, verbose_name='Товарный знак')),
                ('trademark_ky', models.CharField(max_length=255, null=True, unique=True, verbose_name='Товарный знак')),
                ...
                ('company_address_ru', models.TextField(null=True, unique=True, verbose_name='Адрес компании')),
                ('company_address_en', models.TextField(null=True, unique=True, verbose_name='Адрес компании')),
                ('company_address_ky', models.TextField(null=True, unique=True, verbose_name='Адрес компании')),
                ...
                ('certificate_type_ru', models.CharField(choices=[('Сертифицированный', 'Сертифицированный'), ('В процессе', 'В процессе'), ('Приостановлено', 'Приостановлено'), ('Истекший', 'Истекший')], max_length=50, null=True, verbose_name='Тип сертификата')),
                ('certificate_type_en', models.CharField(choices=[('Сертифицированный', 'Сертифицированный'), ('В процессе', 'В процессе'), ('Приостановлено', 'Приостановлено'), ('Истекший', 'Истекший')], max_length=50, null=True, verbose_name='Тип сертификата')),
                ('certificate_type_ky', models.CharField(choices=[('Сертифицированный', 'Сертифицированный'), ('В процессе', 'В процессе'), ('Приостановлено', 'Приостановлено'), ('Истекший', 'Истекший')], max_length=50, null=True, verbose_name='Тип сертификата')),
