...
#    code_type = models.ForeignKey(CodeType, on_delete=models.CASCADE, verbose_name='Тип кода')
#    type_of_origin = models.ForeignKey(TypeOfOrigin, on_delete=models.CASCADE, verbose_name='Тип происхождения')
